...
export const metadata: Metadata = {
  title: "Case Studies",
  description: "Real systems shipped and running in production. See how Enabridge has delivered POS ecosystems, compliance engines, and e-wallet platforms.",
};
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {caseStudies.map((cs) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-text-muted">{cs.tagline}</p>
